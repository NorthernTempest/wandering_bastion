...
- In order to help the player characters naturally form into a cohesive party, include how your character established a strong relationship with one of the following:
	...
	- One or more of the staff at the cathedral. For example:
		- [Mother Wilhelmina Yrstrone](../../creature/unique/npc/wilhelmina-yrstrone.md) of the [Monastic Order of the Arches](../../creature/org/religion/arcundus/monastic-order-of-the-arches.md), beloved leader of the cathedral's multidenominational priesthood.
